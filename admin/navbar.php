        ...
        <div class="container">
            <div class="row row1">
                <ul class="largenav pull-right">
                    ...
                    <li class="upper-links"><a class="links" href="tampil-pesanan.php"> <span class="glyphicon glyphicon-info-sign"></span> Pesanan</a></li>
                    <li class="upper-links"><a class="links" href="contact.php"> <span class="glyphicon glyphicon-user"></span> Kritik Dan Saran</a></li>
                    <li class="upper-links"><a class="links" href="tampil-user.php"> <span class="glyphicon glyphicon-bullhorn"></span>Profil</a></li>
                    <li class="upper-links"><a class="links" href="../logout.php"> <span class="glyphicon glyphicon-lock"></span> Logout</a></li>
                </ul>
            </div>
            <div class="row row2">
                <div class="col-sm-3">
